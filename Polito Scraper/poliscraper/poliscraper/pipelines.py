...
#         create_professors_table = ("CREATE TABLE IF NOT EXISTS professors ("
#                                 "PID CHAR(6) PRIMARY KEY,"
#                                 "Name VARCHAR(255),"
#                                 "Title VARCHAR(255),"
#                                 "Department VARCHAR(255),"
#                                 "Email VARCHAR(255))")
#         create_teaches_table = ("CREATE TABLE IF NOT EXISTS teaches ("
#                                 "PID CHAR(6),"
#                                 "CID CHAR(7),"
#                                 "PRIMARY KEY (PID, CID))")
...
#                          "(PID, Name, Title, Department, Email)"
#                          "VALUES (%s, %s, %s, %s, %s)")
#         data_professor = (item["professor_id"], item["name"], item["title"], item["department"], item["email"])
#         self.curr.execute(add_professor, data_professor)
        
#         add_teaching = ("INSERT INTO teaches"
#                         "(PID, CID)"
#                         "VALUES (%s, %s)")
#         data_teaching = (item["professor_id"], item["cid"])
#         self.curr.execute(add_teaching, data_teaching)
        
#         add_course = ("INSERT INTO course"
#                       "(CID, Cname, Language, Credits, ExType)"
#                       "VALUES (%s, %s, %s, %i, %s)")
#         data_course = (item["cid"], item["cname"], item["lang"], item["credit"], item["etype"])
